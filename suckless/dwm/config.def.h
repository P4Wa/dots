...
static const char *fonts[]          = { "JetBrainsMonoNerdFont-Regular:size=12" };
...
static const char scratchpadname[] = "st-mini";
...
static const Key keys[] = {
	...
	TAGKEYS(                        XK_8,                      7)
	TAGKEYS(                        XK_9,                      8)
	{ MODKEY|ShiftMask,             XK_q,      spawn,          SHCMD("shutdownmenu") },
	{ MODKEY|ShiftMask,             XK_s,      spawn,          SHCMD("maimpick") },
	{ MODKEY,			XK_F3,     spawn,          {.v = (const char*[]){ "st", "-g", "103x24", "-t", "calculator", "-e", "bc", NULL } } },
